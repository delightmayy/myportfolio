...
const Resume = () => {
  ...
  return (
    <>
      <div className="bg-pink-400/75  dark:bg-[url('../src/img/homebg.jpg')] bg-[url('../src/img/lightbg.jpg')] dark:bg-black/95 bg-blend-color  dark:bg-blend-overlay pt-12 min-h-screen flex-1 flex flex-col  p-6 lg:px-8 dark:text-white ">
        <div
